...
<body>
    <div class="center">
        ...
        <form action="Patient-login.php" method="post">
            ...
            <div class="pass"><a href="Patient-Forgot-Password.php">Forget Password?</a>
            </div>

            <input type="submit" value="login" name="login_btn">
            <div class="signup_link">Don't have an account yet? <a href="Patient-register.php">Create an
                    account</a>
        </form>
        <br>
