...
<body>
  ...
  <div class="main-content">
    ...
    <main>
      ...
      <div class="mainTitle">
        <h3>Doctor | Update Medical Record</h3><br>
      </div>

      <div class="content">

        <form action="Update-Medical-Record.php" method="post">
          ...
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="text" placeholder="Enter your Name" id="doctor" name="doctor" value="<?php echo $MRU_doctor; ?>" required>
            </div>

            <div class="input-box">
              <span class="details">Patient Name</span>
              <input type="text" placeholder="Enter patient Name" id="patient" name="patient" value="<?php echo $MRU_patient; ?>" required>
            </div>


            <div class="input-box">
              <span class="details">Patient Weight</span>
              <input type="number" placeholder="Enter patient Weight" id="weight" name="weight" value="<?php echo $MRU_weight; ?>" required>
            </div>

            <div class="input-box">
              <span class="details">Patient Height</span>
              <input type="number" placeholder="Enter patient Height" id="height" name="height" value="<?php echo $MRU_height; ?>" required>
            </div>

            <div class="input-box">
              <span class="details">Patient Age</span>
              <input type="number" placeholder="Enter patient Age" id="age" name="age" value="<?php echo $MRU_age; ?>" required>
            </div>

            <div class="input-box">
              <span class="details">Patient Blood Pressure</span>
              <input type="text" placeholder="Enter patient Blood Pressure" id="BPressure" name="BPressure" value="<?php echo $MRU_BPressure; ?>" required>
            </div>

            <div class="input-box">
              <span class="details">Patient Blood Sugar Level</span>
              <input type="text" placeholder="Enter patient Blood Sugar Level" id="BSugar" name="BSugar" value="<?php echo $MRU_BSugar; ?>"required>
            </div>

            <div class="input-box">
              <span class="details">Patient Heart Rate</span>
              <input type="text" placeholder="Enter patient Heart Rate" id="heart" name="heart" value="<?php echo $MRU_heart; ?>" required>
            </div>
            <div class="input-box">
          ...
          <div class="button">
            <input type="submit" value="Update" name="mr_update_btn">
          </div>
