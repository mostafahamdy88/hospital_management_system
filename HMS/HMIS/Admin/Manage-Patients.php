                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="" method="post">
                                        <input type="text" name="P_delete_id" value="<?php echo $row['id']; ?>" style="display: none;">
                                        <button class="delete-btn" type="submit" name="P_delete_btn" style="background-color:red; color:white; width:80px; height:30px; border-radius: 7px;" onclick="alert('Successfully Patient has been deleted..')"> Delete</button>
                                    </form>
                                </td>
                            </tr>
                    <?php
