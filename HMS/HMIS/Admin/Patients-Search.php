...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            <div class="mainTitle">
                <h3>Admin | Search Patients</h3><br>
            </div>
            <div>
                <h4 style="text-align: center;">Fliter by Username</h4>
            </div>
            <form action="Patients-Search.php" method="post">
                <div class="search_wrap search_wrap_3">
                    <div class="search_box" style="align-content: center;">
                        <input type="text" class="input" placeholder="search..." name="valueToSearch">
                        <div>
                            <input class="btn" type="submit" name="P_search" value="Filter" style="height:50px; width:90px; color:white; font-size:18px;">
                        </div>
                    </div>
                </div>
                <table class="content-table">
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_array($SP_filter_Result)) : ?>
                            <tr>
